module.exports = {
  ...
  'use-custom-logger': {
    boolean: true,
    group: 'Execution:',
    describe: `Use Detox' custom console-logging implementation, for logging Detox (non-device) logs. Disabling will fallback to node.js / test-runner's implementation`,
  },
  'force-adb-install': {
    boolean: true,
    group: 'Execution:',
